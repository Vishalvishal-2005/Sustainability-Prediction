 ...
 * requests to a specified API. The results are navigated to a results page upon successful prediction.
 *
 * @returns {JSX.Element} The rendered component containing file upload and prediction functionalities.
 */
